...
then 
    ...
    sudo cp /app/000-default.conf /etc/apache2/sites-available/000-default.conf
    sudo cp /app/apache2.conf /etc/apache2/apache2.conf
    source /etc/apache2/envvars
    apache2 -k graceful
    sudo chown -R www-data:www-data /var/www 2> /dev/null
fi
